/*
  ...
  - Added the required column `pricePaidInRupees` to the `Order` table without a default value. This is not possible if the table is not empty.
  - Added the required column `priceInRupees` to the `Product` table without a default value. This is not possible if the table is not empty.
