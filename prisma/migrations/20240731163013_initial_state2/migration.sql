/*
  ...
  - You are about to drop the column `pricePaidInRupees` on the `Order` table. All the data in the column will be lost.
  - You are about to drop the column `priceInRupees` on the `Product` table. All the data in the column will be lost.
